    ...
    private suspend fun headlinesInternet(countryCode: String ) {
        ...
        try {
            ...
            if(internetConnection(this.getApplication())){
                ...
                headlines.postValue(Resource.Error("No hay conexión a internet"))

            }
        }catch(t: Throwable){
            when(t){
                is IOException -> headlines.postValue(Resource.Error("No fue posible conectarse"))
                else -> headlines.postValue(Resource.Error("No hay señal"))
            }
        }
    }
    ...
    private suspend fun searchNewsInternet(searchQuery: String){
        ...
        try{
            if(internetConnection((this.getApplication()))){
                ...
                searchNews.postValue((Resource.Error("No hay conexión a internet")))
